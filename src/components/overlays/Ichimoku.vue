    ...
    methods: {
        ...
        draw(ctx) {
            ...
            if (this.showFillKumo) {
                ...
                let ind = 0;
                for (const currItem of data) {
                    if (ind > 1) {
                        let p1 = this.map_senkou_span_values(data[ind - 1]);
            ...
            if (this.showSenkouSpanA) {
                ...
                for (const pSenkouSpanA of data) {
            ...
            if (this.colorSenkouSpanB) {
                this.ctxSenkouSpanB.beginPath();
                for (const pSenkouSpanB of data) {
